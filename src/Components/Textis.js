...
<button className='btn btn-danger mb-3'onClick={clearText}>Clear Text</button>
  <textarea className="form-control" id="exampleFormControlTextarea1" value={text} onChange={handleChange} style={{backgroundColor: props.mode==='light'?'white':'grey', color: props.mode==='white'?'dark':'white'}} rows="8" placeholder='Enter Text'/>
</div>
